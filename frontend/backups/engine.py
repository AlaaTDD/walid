...
from app.nesting.rotation import ALL_ROTATIONS, LockedRotation, rotate_shape
...
_PACKING_STRATEGIES: tuple[tuple[str, str], ...] = (
    ...
    ("max_side_desc", "bottom_left"),
    ("bbox_area_desc", "bottom_left"),
    ("perimeter_desc", "bottom_left"),
    ("area_desc", "compact"),
    ("max_side_desc", "compact"),
)
...
def _place_one_part(
    ...
    *,
    ...
    best_for_part: tuple[tuple[float, float], LockedRotation, BaseGeometry, tuple[float, float]] | None = None
    for rotation in rotations:
        ...
        if best_for_part is None or score < best_for_part[0]:
            best_for_part = (score, rotation.angle, final_shape, position)
    if best_for_part is None:
        return None
    return best_for_part[1], best_for_part[2], best_for_part[3]
